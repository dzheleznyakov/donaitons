    ...
    <div className="App">
        ...
        <p>
          <MultiLanguageComponent
            en={
              ...
              " This rescue operation is ongoing, and so far they brought over 170 orphan children from" +
              " Kharkiv, Kherson, Irpin and Donetsk region." +
              " Over 50 of them are babies." +
              " These children became orphans either during their early life or during this war." +
            ...
            ru={
              ...
              " Эта спасательная операция продолжается, и на сегодняшний день они привезли более" +
              " 170 детей-сирот из Харькова, Херсона, а также Ирпени и Донецкой области. Из них более 50 детки младенцы." +
        ...
        <p>
          <MultiLanguageComponent 
            ...
            ru={
              ...
              " чтобы заботиться и морально поддерживать детей. Они проводят время с детьми все семь дней в неделю." +
        ...
        <p>
          <MultiLanguageComponent
            ...
            ru={
              ...
              " недавно эвакуированных из Ирпени и Донецкой области."
            }
          />
        </p>
        ...
        <p style={{fontSize: '30px', fontWeight: 'bold', color: 'darkgreen'}}>
          <MultiLanguageComponent
            ...
            ru={
              ...
              " (подгузники, искусственное молоко и т.д)"
            }
          />
        </p>
      ...
      <div className="TextWrapper">
        ...
        <ul className="Results">
          <li>
            <MultiLanguageComponent
              en='bought vital medicine for both the "Cafe" and the "School no. 3": on the way from Germany, but delayed at the customs waiting for the custom.'
          ...
          <li>
            <MultiLanguageComponent
              en="ordered another batch of medicaiton needed for the other two schools + custom feed "
              ru="заказали еще одну партию лекарств, необходимых для других 2 групп детей и оплатили приобретенный таможенный сбор"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en="got two second-hand baby cots: delivered, see the photo (now little children can sleep safely and comfortably, as they slept on the foldable camping beds)"
              ru="купили две б/у детские кроватки (см. фото). Теперь маленькие детки могут спать безопасно и комфортно, так как раньше они спали на раскладушках"
            />
          </li>
          <li>
            <MultiLanguageComponent
          ...
          <li>
            <MultiLanguageComponent
              en="bought some fresh groceries (milk, bread, fruit)"
              ru="купили свежих продуктов (молоко, хлеб, фрукты) на одну неделю"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en="got 5 warm jackets and 5 pairs of boots. 2 girls had their jackets torn. Now they are dressed warmly. The weather is -7C"
              ru="купили 5 теплых курток и 5 пар сапог. У двух девочек порвались курточки, а теперь они одеты тепло. Погода -7С"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en='bought pacifiers, muslin cloths, baby dry formula packs for the "School no. 3"'
              ru="купили пустышки, пеленки, детское молоко для одной группы и детские шампуни, детские присыпки для второй группы"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en='bought 2 second-hand prams: one for the "Cafe" and another on for the "School no. 3": delivered, see the photo'
              ru="купили 2 б/у коляски для двух групп, по одной на группу: коляски доставили, см. фото"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en="little boy Misha caught bronchitis and is now in the hospital. We ordered antibiotics for him"
              ru="купили антибиотики. Маленький мальчик Миша заболел бронхитом и сейчас находится в больнице"
            />
          </li>
          <li>
            <MultiLanguageComponent
              en="stocked up with water and food for some time"
          ...
          <li>
            <MultiLanguageComponent
              en='and with what was left afterward helped out financially to the "School no. 3" (children shampoos, baby nappy creams, miscellanies)'
